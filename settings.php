                    ...
                    <div class="p-6 md:p-10 space-y-10">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label class="block text-[10px] font-black text-gray-500 uppercase tracking-widest mb-2 ml-1">Contact Number</label>
                                    <input type="tel" id="phone" value="<?php echo htmlspecialchars($userPhone); ?>" class="w-full rounded-xl px-5 py-3.5 text-sm" placeholder="+94 77 123 4567">
                                </div>
