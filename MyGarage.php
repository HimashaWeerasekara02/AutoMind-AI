            ...
            <div class="bg-gray-800 p-8 rounded-2xl w-full max-w-md shadow-2xl border border-gray-700">
                ...
                <form id="add-vehicle-form" class="space-y-4">
                    <div>
                        ...
                        <input id="vehicle-nickname" class="w-full p-3 rounded-lg bg-gray-900 border border-gray-700 focus:border-blue-500 outline-none mt-1 text-white" placeholder="e.g. My Daily" required>
                    </div>
    ...
    async function loadVehicles(){
        try {
            ...
            if(!data || Object.keys(data).length === 0){
                list.innerHTML = `<div class="col-span-full text-center py-20 bg-gray-800/30 rounded-2xl border-2 border-dashed border-gray-700"><p class="text-xl text-gray-500 font-medium">Your garage is currently empty.</p></div>`;
                return;
            }
            ...
            for(const id in data){
                ...
                <div class="bg-gray-800 p-6 rounded-2xl border border-gray-700 vehicle-card hover:border-blue-500 transition-all shadow-lg group">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            <h3 class="text-2xl font-bold text-white group-hover:text-blue-400 transition-colors uppercase tracking-tight">${v.nickname}</h3>
                    ...
                    <div class="flex gap-2 mt-6">
                        <a href="glovebox.php?vehicle_id=${id}&name=${encodeURIComponent(v.nickname)}" class="flex-1 bg-gray-700 hover:bg-blue-600 text-white py-2.5 rounded-xl text-sm font-bold text-center transition duration-200">Glove Box</a>
